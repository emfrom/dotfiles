...
#+begin_src emacs-lisp
  ...
  ;;
  (defvar emfrom/side-window-agenda nil
    "Side window displaying org agenda")

  (defun emfrom/org-agenda-side-window ()
    "Toggle the visibility of a side window with the Org Agenda."
    (interactive)
    (if emfrom/side-window-agenda
        (progn
          (delete-window emfrom/side-window-agenda)
